...
file.name <- "Production_Test"
minDBH <- 10 # Minimum DBH threshold; set same for both primary & secondary right now
pharv <- 1 # Harvest probability; set same for both primary & secondary right now
aharv <- 0.02 # fraction area harvested; set same for both primary & secondary right now; SET TO 0 TO SEE IF THIS IS USED
